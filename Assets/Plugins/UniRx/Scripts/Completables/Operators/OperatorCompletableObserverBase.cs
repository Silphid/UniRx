...
namespace UniRx.Completables.Operators
{
    ...
    {
        public PassthroughCompletableObserver(ICompletableObserver observer, IDisposable cancel) : base(observer, cancel)
        {
        }
    ...
    {
        public PassthroughCompletableToObservableObserver(IObserver<T> observer, IDisposable cancel) : base(observer, cancel)
        {
        }
    ...
    {
        public PassthroughObservableToCompletableObserver(ICompletableObserver observer, IDisposable cancel) : base(observer, cancel)
        {
        }
