        ...
        private class ThenObserver : IObserver<TSource>, IDisposable
        {
            ...
            public void OnCompleted()
            {
                ...
                else
                {
                    ...
                    {
                        observer.OnError(new InvalidOperationException("Then() operator never received OnNext() call from parent observable, necessary in order to pass an argument to selector Func<T, ICompletable>"));
                    }
                }
            }
