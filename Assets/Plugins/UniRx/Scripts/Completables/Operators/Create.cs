...
namespace UniRx.Completables.Operators
{
    internal class CreateCompletable : OperatorCompletableBase
    {
        ...
        public CreateCompletable(Func<ICompletableObserver, IDisposable> subscribe, bool isRequiredSubscribeOnCurrentThread)
        ...
        {
            public Create(ICompletableObserver observer, IDisposable cancel) : base(observer, cancel)
            {
            }
    ...
    internal class CreateCompletable<TState> : OperatorCompletableBase
    {
        ...
        public CreateCompletable(TState state, Func<TState, ICompletableObserver, IDisposable> subscribe, bool isRequiredSubscribeOnCurrentThread)
            : base(isRequiredSubscribeOnCurrentThread)
        {
            this.state = state;
            this.subscribe = subscribe;
