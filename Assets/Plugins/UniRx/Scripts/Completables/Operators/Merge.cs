...
namespace UniRx.Completables.Operators
{
    internal class MergeCompletable : OperatorCompletableBase
    {
        ...
        public MergeCompletable(IObservable<ICompletable> sources, int maxConcurrent, bool isRequiredSubscribeOnCurrentThread)
            : base(isRequiredSubscribeOnCurrentThread)
        {
            this.sources = sources;
        ...
        private class UnlimitedConcurrentMergeObserver : OperatorObservableToCompletableObserverBase<ICompletable>
        {
            ...
            public UnlimitedConcurrentMergeObserver(MergeCompletable parent, ICompletableObserver observer, IDisposable cancel) : base(observer, cancel)
            {
                this.parent = parent;
            }
        ...
        private class LimitedConcurrentMergeObserver : OperatorObservableToCompletableObserverBase<ICompletable>
        {
            ...
            public LimitedConcurrentMergeObserver(MergeCompletable parent, ICompletableObserver observer, IDisposable cancel) : base(observer, cancel)
            {
                this.parent = parent;
            }
